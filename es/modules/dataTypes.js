...
var _ref =
/*#__PURE__*/
React.createElement("span", null, selectProgramText);
...
const getReportingRates = (contents, groupSetId) => {
  ...
  groupSetId === ALL_ID ? DATA_SETS_CONSTANTS.forEach(reportingRate => dataSets = [...dataSets, ...contents.map(dataSet => concatReportingRate(dataSet, reportingRate))]) : dataSets = contents.map(dataSet => concatReportingRate(dataSet, reportingRateIndex));
  return dataSets;
};
