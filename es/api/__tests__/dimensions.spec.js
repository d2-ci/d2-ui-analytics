import { apiFetchAlternatives, apiFetchGroups, apiFetchDimensions } from '../dimensions';
let mockD2;
let mockGetFn;
let dimensionProps;
  ...
  describe('apiFetchAlternatives', () => {
    ...
    describe('eventDataItems', () => {
      ...
      it('returns the correct dimension items', done => {
        ...
        setTimeout(() => {
          expect(apiFetchAlternatives(dimensionProps)).resolves.toEqual(expectedResult);
          done();
        });
      });
