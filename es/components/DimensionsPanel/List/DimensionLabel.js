...
/*#__PURE__*/
function (_Component) {
  _inherits(DimensionLabel, _Component);
  ...
  function DimensionLabel() {
    ...
    _classCallCheck(this, DimensionLabel);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DimensionLabel)).call.apply(_getPrototypeOf2, [this].concat(args)));
