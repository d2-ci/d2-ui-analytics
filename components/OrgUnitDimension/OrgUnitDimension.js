...
function (_Component) {
  ...
  function OrgUnitDimension(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setOuUiItems", function (ids) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onLevelChange", function (event) {
      ...
      _this.props.onSelect({
        dimensionType: ouId,
        value: [].concat(_toConsumableArray(_this.props.ouItems.filter(function (ou) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOrgUnitClick", function (event, orgUnit) {
      ...
      if (selected.some(function (ou) {
        ...
        _this.props.onSelect({
          dimensionType: ouId,
          value: [].concat(_toConsumableArray(selected), [_objectSpread({}, orgUnit, {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMultipleOrgUnitsSelect", function (orgUnits) {
      ...
      _this.props.onSelect({
        dimensionType: ouId,
        value: [].concat(_toConsumableArray(selected), _toConsumableArray(orgUnits.reduce(function (obj, ou) {
